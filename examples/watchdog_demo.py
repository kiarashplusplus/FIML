...
async def main():
    ...
    # Critical events
    critical_sub = watchdog_manager.subscribe_to_events(
    ...
    high_sub = watchdog_manager.subscribe_to_events(
    ...
    all_sub = watchdog_manager.subscribe_to_events(
        callback=handle_all_events,
    )
    print("   ✓ Subscribed to ALL events")
    
    # Price anomaly events only
    price_sub = watchdog_manager.subscribe_to_events(
