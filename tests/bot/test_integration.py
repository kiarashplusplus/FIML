...
class TestBotIntegration:
    ...
    async def test_complete_lesson_flow(self, bot_components):
        ...
        # Step 1: Load lesson
        lesson = await lesson_engine.load_lesson(lesson_id)
    ...
    async def test_compliance_filtering_in_flow(self, bot_components):
        ...
        result = await compliance.filter_user_question(question)
        ...
        result2 = await compliance.filter_user_question(educational_question)
        assert result2.is_allowed

    async def test_lesson_prerequisites_with_gamification(self, bot_components):
    ...
    async def test_daily_streak_with_lessons(self, bot_components):
