    ...
    def check_compatibility(
        ...
        if user_parts[0] != current_parts[0]:
            ...
            return VersionCompatibility(
                ...
                message=(
                    f"📚 Lesson Updated!\n\n"
                    f"This lesson has major improvements. You can:\n"
                    f"1️⃣ Continue with your current version\n"
                    f"2️⃣ Restart with the new version\n\n"
                    f"Your XP and progress are safe either way! 🎓"
                )
            )
        ...
        # Minor version change = new content
            ...
            return VersionCompatibility(
                ...
                message=(
                    f"📖 Lesson Enhanced!\n\n"
                    f"New content added to this lesson. "
                    f"You'll continue from where you left off. ✨"
                )
            )
